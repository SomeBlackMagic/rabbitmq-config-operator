...
import { ProbeLivenessInterface } from './Probe/ProbeLiveness';
import {Bus} from "@node-ts/bus-core";

export class Probe extends BaseModule<Probe> {

    private bus: Bus;
    private http: WebServer;
    ...
    public constructor(bus?: EventBusInterface<SimpleEventBus>) {
        super();
        this.bus = bus ?? Core.app().get<Bus>('event-bus');
        // this.http = Core.app().getService<WebServer>('http');
